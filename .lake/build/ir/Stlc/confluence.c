...
// Module: Stlc.confluence
// Imports: Init Stlc.basics Stlc.open_close Stlc.context Stlc.typing Stlc.reductions
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Stlc_confluence(uint8_t builtin, lean_object* w) {
lean_object * res;
