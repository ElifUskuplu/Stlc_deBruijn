...
// Module: Stlc.call_by_value
// Imports: Init Stlc.basics Stlc.open_close Stlc.context Stlc.typing
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Stlc_call__by__value(uint8_t builtin, lean_object* w) {
lean_object * res;
