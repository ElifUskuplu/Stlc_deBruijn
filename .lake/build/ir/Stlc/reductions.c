...
// Module: Stlc.reductions
// Imports: Init Stlc.basics Stlc.open_close Stlc.context
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Stlc_reductions(uint8_t builtin, lean_object* w) {
lean_object * res;
